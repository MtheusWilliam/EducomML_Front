    ...
    <v-card>
        ...
        <v-card-text>
            <v-form ref="form" v-model="valid" lazy-validation class="mt-3">
                ...
                <v-text-field id="exemploNameArea" v-model="exemploName" :counter="100" :rules="exemploNameRules" required class="mt-2 mb-4"></v-text-field>
    ...
    <div class="text-center">
        <v-dialog v-model="dialog_alert" width="500">
            <v-card>
                ...
                <v-card-text class="mt-3" style="font-size: 1.3em;">Para salvar um exemplo, é necessário inserir pelo algum conteúdo (MobileMedia).</v-card-text>
                <v-divider></v-divider>
                <v-card-actions>
                    <v-spacer></v-spacer>
