    ...
    <v-card>
      <v-form ref="form" v-model="valid" lazy-validation>
        ...
        <v-card-text>
          ...
          ></v-file-input>
          <label v-if="mobilemedia" class="mr-2" for="viewAudioIconId"
            >Visualizar Audio</label
          >
      ...
      <v-dialog v-model="dialog_alert" width="500">
        <v-card>
          ...
          <v-card-text class="mt-3" style="font-size: 1.3em;"
            >É necessário importar algum áudio.</v-card-text
          >
          <v-divider></v-divider>
          <v-card-actions>
            <v-spacer></v-spacer>
        ...
        if (this.mobilemedia) {
          ...
          this.$nextTick(async function() {
            ...
            if (vm.mobilemedia.fk_informationitem) {
              ...
              Api()
                .patch(vm.mobilemedia.fk_informationitem, headers, {
                  auth: {
                    username: "admin",
                    password: "admin",
                  },
