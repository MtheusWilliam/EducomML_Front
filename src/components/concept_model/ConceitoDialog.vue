        ...
        <v-card>
            ...
            <v-card-text>
                <v-form ref="form" v-model="valid" lazy-validation>
                    ...
                    <v-row>
                        <v-col>
                            <v-select v-model="select" :items="items" label="Conceito" style="margin:0px;"></v-select>
                        </v-col>
                        <v-col>
                            <v-text-field v-model="relacaoName" counter="15" label="Nome da Relação" style="margin:0px;"></v-text-field>
                        </v-col>
                        <v-col>
                            <v-select v-model="select" :items="relacaoTypes" label="Tipo da Relação" style="margin:0px;"></v-select>
                        </v-col>
