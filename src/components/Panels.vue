    ...
    <v-expansion-panels>
        <v-expansion-panel v-for="(item,i) in 1" :key="i">
                ...
                <v-row>
                    ...
                    <v-col cols="3">
                        ...
                        <v-dialog v-model="dialog_modulo" persistent="persistent" max-width="600px">
                            ...
                            <ModuloDialog :module="modulo" @close_or_save="close_or_save_modulo" :domain="dominio" :dialog="dialog_modulo" />
                        </v-dialog>
                        ...
                        <v-dialog v-model="dialog_dominio" persistent="persistent" max-width="600px">
                            ...
                            <DominioDialog @close_or_save="close_or_save_dominio" @dominio_data="setDomainVariables" :domain="dominio_data" :dialog="dialog_dominio" />
                        </v-dialog>

                        <!--Formulario para criação de submódulo-->
                        <v-dialog v-model="dialog_submodulo" persistent="persistent" max-width="600px">
                            <SubModuloDialog :submodule="submodulo" :module="modulo" @close_or_save="close_or_save_submodulo " :domain="dominio" :dialog="dialog_submodulo" />
                        </v-dialog>
                        <!--Formulario para criação de conceito-->
                        <v-dialog style="overflow-y:hidden; overflow-x:hidden;" v-model="dialog_conceito" persistent="persistent" max-width="745px" max-height="530px">
                            <ConceitoDialog :concept="conceito" :module="modulo" @close_or_save="close_or_save_conceito" :domain="dominio" :dialog="dialog_conceito" />
                        </v-dialog>
            ...
            <v-expansion-panel-content>
                ...
                <!--Panels dos Módulos-->
                <v-expansion-panels v-for="(modulo) in dominio_data.modules" :key="modulo.idmodule" class="mt-2 mb-2">
                    <v-expansion-panel v-if="modulo.fk_idmodule === null">
                            ...
                            <v-row>
                                ...
                                <v-col cols="3">
                                    ...
                                    <v-menu top="top" width="300px" origin="center center" :offset-y="true" transition="scale-transition">
                                        ...
                                        <MenuFiles @dialogoption="openFileDialog" :optionCall="modulo" :type="'modulo'"/>
                                    </v-menu>
                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-expansion-panels v-for="(submodulo) in modulo.submodules" :key="submodulo.idmodule" class="mt-2 mb-2">
                                <v-expansion-panel>
                                        ...
                                        <v-row>
                                            ...
                                            <v-col cols="3">
                                                ...
                                                <v-menu top="top" width="300px" origin="center center" :offset-y="true" transition="scale-transition">
                                                    ...
                                                    <MenuFiles @dialogoption="openFileDialog()" :optionCall="submodulo" :tipo="'modulo'"/>
                                                </v-menu>
                                                <!--Formulario para adição de conceito-->
                                                <v-btn icon="icon" color="white" @click="setmodulo(submodulo);dialog_conceito=true">
                                                    <v-icon>mdi-plus</v-icon>
                                                </v-btn>
                                    ...
                                    <v-expansion-panel-content>
                                        ...
                                        <v-expansion-panels v-for="(conceito) in submodulo.concepts" :key="conceito.idconceito" class="mt-2 mb-2">
                                            <v-expansion-panel>
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col cols="3">
                                                            ...
                                                            <v-menu top="top" width="300px" origin="center center" :offset-y="true" transition="scale-transition">
                                                                ...
                                                                <MenuFiles @dialogoption="openFileDialog()" :optionCall="conceito" :type="'conceito'"/>
                                                            </v-menu>

                                                            <!--Formulario para edição do conceito-->
                                                            <v-btn icon="icon" color="white" @click="setconceito(conceito, submodulo);dialog_conceito=true">
                                                                <v-icon>mdi-view-headline</v-icon>
                                                            </v-btn>
                            ...
                            <v-expansion-panels v-for="(conceito) in modulo.concepts" :key="conceito.idconceito" class="mt-2 mb-2">
                                <v-expansion-panel>
                                    <v-expansion-panel-header color="#00C853" style="color:white;">
                                        <v-row>
                                            <v-col cols="9">
                                            ...
                                            <v-col cols="3">
                                                ...
                                                <!--Formulario para edição do conceito-->
                                                <v-btn icon="icon" color="white" @click="setconceito(conceito, modulo);dialog_conceito=true">
                                                    <v-icon>mdi-view-headline</v-icon>
                                                </v-btn>
                                                <!--Função para excluir conceito-->
                                                <v-btn icon="icon" color="white" @click="deleteelemento(conceito)">
                                    ...
                                    <v-expansion-panel-content>
                                        ...
                                        <v-simple-table>
                                            <template v-slot:default>
                                                ...
                                                <tbody>
                                                    <tr v-for="relacao in conceito.sourceconcept" :key="relacao.idreference">
