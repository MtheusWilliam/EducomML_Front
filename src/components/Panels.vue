                ...
                <v-row>
                    ...
                    <v-col cols="3">
                        ...
                        <v-dialog v-model="dialog_modulo" persistent="persistent" max-width="600px">
                            ...
                            <ModuloDialog :module="modulo" @close_or_save="close_or_save_modulo" :domain="dominio" />
                        </v-dialog>
                        ...
                        <v-dialog v-model="dialog_submodulo" persistent="persistent" max-width="600px">
                            <SubModuloDialog :submodule="submodulo" :module="modulo" @close_or_save="close_or_save_submodulo " :domain="dominio" />
                        </v-dialog>
                        <!--Formulario para criação de conceito-->
                        <v-dialog v-model="dialog_conceito" persistent="persistent" class="mx-0" max-width="750px">
                            <ConceitoDialog :concept="conceito" :module="modulo" @close_or_save="close_or_save_conceito" :domain="dominio" />
                        </v-dialog>
                    </v-col>
                </v-row>
                        ...
                        <v-expansion-panel-header color="primary" style="color:white;">
                            <v-row>
                                ...
                                <v-col cols="3">
                                    ...
                                    <v-menu top="top" origin="center center" :offset-y="true" transition="scale-transition">
                                        <template v-slot:activator="{ on }">
