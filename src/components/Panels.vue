            ...
            <v-expansion-panel v-for="(item,i) in 1" :key="i">
                ...
                <v-expansion-panel-content>
                    ...
                    <v-expansion-panels v-for="(modulo) in modulos" :key="modulo.idmodule">
                        <v-expansion-panel>
                            <v-expansion-panel-header>[Modulo]
                                {{ modulo.namemodule }}</v-expansion-panel-header>
     ...
     */
        ...
        methods: {
            ...
            getDominio() {
                ...
                axios
                    .patch(
                        "http://127.0.0.1:8000/knowledgedomain/" + this.dominio_data.idknowledgedomain +
                                "/",
                        {
                            headers: headers
                        },
